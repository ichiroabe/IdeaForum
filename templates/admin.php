    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <?php if ($r['idea_id']): ?><a href="/ideas/<?= (int)$r['idea_id'] ?>">#<?= (int)$r['target_id'] ?></a><?php endif; ?>
        </td>
        ...
        <td class="actions">
          ...
          <form method="post" action="/admin/resolve-report" class="inline-form">
            <?= Csrf::field() ?>
  ...
  <table class="admin-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <?php if ($u['role'] !== 'admin'): ?>
          <form method="post" action="/admin/toggle-ban" class="inline-form">
            <?= Csrf::field() ?>
